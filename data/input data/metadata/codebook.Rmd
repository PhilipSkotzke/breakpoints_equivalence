...
The data is collected from national level male triathletes (Performance Tier3 according to McKay et al., 2022) performing an incremental running test on a 400 m outdoor track. The test commenced at 8 km/h for 2 minutes. After that, the speed increased by 0.5 km/h every minute. Pacing was provided using an acoustic signal when the participant was passing a cone every 20 m.
...
var_label(data_NIRS_BPs_2025) <- list(
  ...
  ATT_left = "Adipose Tissue Thickness at the left vastus lateralis muscle in milimeters.",
  ATT_right = "Adipose Tissue Thickness at the right vastus lateralis muscle in milimeters.",
  Tet_duration = "Total duration of the incremental test in seconds",
